...
(custom-set-variables
 ...
 '(default-frame-alist (quote ((tool-bar-lines . 0) (fringe) (vertical-scroll-bars) (menu-bar-lines . 0) (background-color . "#0C1021") (background-mode . dark) (border-color . "#dedede") (cursor-color . "#AFAFAF") (foreground-color . "#F8F8F8") (mouse-color . "sienna1") (left-fringe . 0) (right-fringe . 0))))
