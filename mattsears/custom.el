;;----------------------------------------------------------------------------
;; Aquamacs specific customizations
;;----------------------------------------------------------------------------
(custom-set-variables
 ...
 ;; '(cursor-type 'box)
 '(default-frame-alist (quote ((tool-bar-lines . 0) (fringe) (vertical-scroll-bars) (menu-bar-lines . 0) (background-color . "#0C1021") (background-mode . dark) (border-color . "#dedede") (cursor-color . "#373c4e") (foreground-color . "#EEEEEE") (mouse-color . "sienna1") (left-fringe . 0) (right-fringe . 0))))
