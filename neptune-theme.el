...
(let ((class '((class color) (min-colors 89)))
      ...
      (custom-theme-set-faces
       ...
       `(font-lock-warning-face ((,class (:foreground ,neptune-red-0))))
       ...
       `(helm-ff-directory ((,class (:foreground ,neptune-green-0))))
       `(helm-ff-dotted-directory ((,class (:foreground ,neptune-green-0 :background ,neptune-bg))))
       `(helm-ff-dotted-symlink-directory ((,class (:foreground ,neptune-green-0 :background ,neptune-bg))))
       ...
       `(match ((,class (:background ,neptune-red-0))))
       ...
       `(org-level-1 ((,class (:foreground ,neptune-red-0))))
