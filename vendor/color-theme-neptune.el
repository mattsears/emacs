...
(defun color-theme-neptune()
  ...
  (color-theme-install
   '(color-theme-neptune
     ...
     (neptune-blue ((t (:foreground "#578ec3"))))
     (neptune-light-blue ((t (:foreground "#e1f3f8"))))
     (neptune-orange ((t (:foreground "#e17548"))))
     ...
     (neptune-red ((t (:foreground "#d95c47"))))
     ...
     (neptune-highlight ((t (:background "#623e66" :foreground "#eeeeee"))))
